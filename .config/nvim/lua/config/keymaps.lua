...
vim.keymap.set("n", "gg", "gg0", d("Go to first line, first column"))
vim.keymap.set("n", "G", "G$", d("Go to last line, end of line"))
vim.keymap.set("v", "gg", "gg0", d("Go to first line, first column"))
vim.keymap.set("v", "G", "G$", d("Go to last line, end of line"))
