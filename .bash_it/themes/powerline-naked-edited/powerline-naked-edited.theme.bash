...
. "$BASH_IT/themes/powerline-naked-edited/powerline-naked-edited.base.bash"
...
USER_INFO_THEME_PROMPT_COLOR=${POWERLINE_USER_INFO_COLOR:=120}
...
SCM_THEME_PROMPT_CLEAN_COLOR=${POWERLINE_SCM_CLEAN_COLOR:=105}
SCM_THEME_PROMPT_DIRTY_COLOR=${POWERLINE_SCM_DIRTY_COLOR:=160}
